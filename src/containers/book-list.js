...
function mapStateToProps(state) {
	//the purpose of this function is to take the state as an argument 
	//and whatever is returned will show up as props inside BookList
	return {
		books: state.books
	}
}
...
//dispatch method, selectBook. Make it avialable as a prop
